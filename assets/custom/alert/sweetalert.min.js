...
function swal_success(title = "", msg = "") {
	Swal.fire({
	  icon: 'success',
	  title: title,
...
function swal_success_reload(title = "", msg = "") {
	Swal.fire({
	  icon: 'success',
	  title: title,
	  allowOutsideClick: false,
...
function swal_confirm(title = "", msg = "", btn_msg = "", callback) {
	const swalWithBootstrapButtons = Swal.mixin({
	  customClass: {
	    confirmButton: 'btn btn-success ml10',
	    cancelButton: 'btn btn-danger mr10'
	  },
...
function swal_wait($msg = "Please Wait") {
    Swal.fire({
      title: "Please Wait ... ",
      text: $msg,
