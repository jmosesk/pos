  <div class="pageheader">
    	<h2><i class="fa fa-sliders"></i> Supplier Summary Report</h2>
	<p class="mb20 text-muted">View and Filter Supplier Summary Report for given date range</p>
  </div>
          ...
          <div id="export_div" style="display:none">
            <div class="col-md-12">
              <form action="<?php echo base_url('Export') ?>" method="POST" target="_blank">
                  <input type="hidden" name="sub_heading" id="sub_heading" value='<?php echo json_encode(array('sub_heading_1' => 'Supplier Summary Report', 'sub_heading_2' => '')) ?>'>
                  ...
                  <input type="hidden" name="filename" id="filename" value="Supplier Summary Statement">
  ...
  <script type="text/javascript">
    $("#generate_report").click(function(e) {
        ...
        $.ajax({
            url: '<?php echo base_url("ShiftReports/supplierSummaryReport") ?>',
            type: 'POST',
    ...
    function initialize_export(data) {
        ...
        sub_heading['sub_heading_1'] = 'Supplier Summary Report for a Period of ' + date_range;
        sub_heading['sub_heading_2'] = '';
        $('#filename').val('Supplier Summary ' + date_range);
        export_header += data;
    ...
    function open_main_table() {
          draw_panel = '<table class="table table-condensed mb0"><thead><tr><th width="25%">Supplier Name</th><th width="15%" style="text-align:right">BBF</th><th width="15%" style="text-align:right">Debt Incurred</th><th width="15%" style="text-align:right">Total</th><th width="15%" style="text-align:right">Paid</th><th width="15%" style="text-align:right">Balance</th></tr>';
