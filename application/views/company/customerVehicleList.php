        ...
        <div class="modal-content">
          ...
          <form id="addForm" method="post" class="form-horizontal" enctype="multipart/form-data">
            <div class="form-group">
              <label class="col-lg-4 control-label">Select Customer : <sup>*</sup></label>
              <div class="col-lg-7">
                <input type="hidden" class="form-control" name="type" value="customer" />
  ...
  <!-- End of Modal-->
    ...
    <div class="pageheader">
      <h2><i class="fa fa-edit"></i> Customer Vehicles</h2>
    </div>
    <div class="contentpanel">
          <div class="panel panel-default">
            <div class="panel-heading">
              <div class="row">
                <div class="col-md-6">
                  <h4 class="panel-title"><b>Customer Vehicles List</b></h4>
                  <p>View, add and Edit Customer Vehicles Details</p>
                </div>
              ...
              <div class="table-responsive">
                <table class="table table-striped mb30">
                  ...
                  <tbody>
                    <?php $row_count = 0;
                      if($vehicles != null) {
                        foreach ($vehicles->result() as $vehicle) { $row_count = ++$row_count; ?>
                    <tr>
                      <td><?php echo $row_count; ?></td>
                      <td><?php echo $vehicle->company_name; ?></td>
                      <td><?php echo $vehicle->registration_number; ?></td>
                      <td><?php echo $vehicle->description; ?></td>                    
                      <td><?php if($vehicle->status == 1) echo "<span class='label label-success'> Active </span>"; else echo "<span class='label label-warning'> InActive </span>"; ?></td>
                      <td><span class="btn btn-warning btn-xs" data-toggle="modal" data-target="#editUser" onclick="edit('<?php echo $vehicle->vehicle_id; ?>')"><span class="glyphicon glyphicon-pencil"></span>&nbsp;Edit</span>  
                          <span class="btn btn-danger btn-xs" onclick="deleteVehicle('<?php echo $vehicle->vehicle_id; ?>','<?php echo $vehicle->registration_number; ?>')"><span class="glyphicon glyphicon-trash"></span>&nbsp;Delete</span>
                        </td>                    
                    </tr>
                    <?php } } ?>
                  </tbody>
