...
<div class="contentpanel">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="<?php echo base_url('Excel') ?>" method="POST" target="_blank">
        ...
        jQuery.each(html.data, function (i, val) {
            ...
            if (html.items[val.customer_transaction_id].length > 0) {                
                jQuery.each((html.items[val.customer_transaction_id]), function (j, item) {
                    ...
                    item_tbl += '<td style="width:24%">' + item.item_name + '</td>';
                    item_tbl += '<td style="width:8%">' + format_amount_decimals(item.unit_price) + '</td>';
                    item_tbl += '<td style="width:7%">' + format_amount_decimals(item.quantity_sold) + '</td>';
                    item_tbl += '<td style="width:8%">' + format_amount_decimals(item.total) + '</td>';
                    ...
                    item_tbl += '<td style="width:10%">' + format_amount_decimals(val.bbf) + '</td>';
                    item_tbl += '</tr>';
                });
            }
