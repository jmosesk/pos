    <div class="pageheader">
      <h2><i class="fa fa-shopping-cart"></i> VAT Return Detailed Report</h2>
      <p class="mb20 text-muted">View and Filter VAT Return File for a Period of Time</p>
    </div>
    ...
    <script type="text/javascript">
      $("#generate_report").click(function(e) {
          ...
          $.ajax({
              url: '<?php echo base_url("ShiftReports/VatDetailed") ?>',
              type: 'POST',
              data: { range: range},
              success: function (response) {
                ...
                var sum_purchases = sum_sales = purchases_vat = sales_vat = 0;
                ...
                var tax_due = sales_vat - purchases_vat;
