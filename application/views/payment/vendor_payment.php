    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Add a Supplier Payment</h4>
            </div>
            <div class="modal-body">
                <form id="addForm" method="post" class="form-horizontal" enctype="multipart/form-data">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="form-group">
                                <label class="col-lg-3 control-label">Select Supplier : </label>
                                <div class="col-lg-8">
                                    <select class="form-control mb15 selectpicker" name="vendor" id="vendor" data-live-search="true" data-style="btn-white">
                                        <option readonly value="">Select a Vendor . . .</option>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary">Add Supplier Payment</button>
                    </div>
                </form>
            </div>
        </div>
...
<div class="pageheader">
    <h2><i class="fa fa-edit"></i> Supplier Payments</h2>
...
<div class="contentpanel">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-md-6">
                <h5 class="subtitle mb5"> Supplier Payments</h5>
                <p class="mb20">Create a Customer Payment or Keep track of existing Supplier Payments</p>
            </div>
            <div class="col-md-6 text-right">
                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#addUser"><span class="fa fa-plus"></span> Create Supplier Payment</button>
            </div>
            <div class="col-md-12">
