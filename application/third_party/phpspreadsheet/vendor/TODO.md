If you want to contribute to the development of SmartHrms, here is a list of things to be implemented.
...
- [ ] Dynamic form for user properties (SmartHrms to become a SAML2 IdP). For superadmin only.
...
- [ ] Simplified time tracking. Not sure because SmartHrms is specialized in LMS. Maybe a side project ?
