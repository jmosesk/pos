 ...
 * @copyright  Copyright (c) 2019-2020 Moses J. Makokha
 * @license      http://opensource.org/licenses/AGPL-3.0 AGPL-3.0
 * @link            https://github.com/jmosesk/SmartHrms
 * @since         0.4.2
 */
...
define('LDAP_LOGIN', '');  //This login must exist in SmartHrms and LDAP
define('LDAP_PASSWORD', '');  //This is the password we will use to bind to LDAP
//-----------------------------------------------------------------
?>
<html>
    <head>
        <title>SmartHrms LDAP Configuration</title>
    ...
    <body>
        <div class="container-fluid">
            <ul class="nav nav-pills">
                <li><a href="home" title="login to SmartHrms"><i class="mdi mdi-home nolink"></i></a></li>
        ...
        if (extension_loaded('ldap')) {
            ...
            try {
                if ($config['ldap_enabled'] == FALSE) {
                    echo '<b>WARNING:</b> LDAP is disabled into SmartHrms configuration file.<br />' . PHP_EOL;
                }
                ...
                if ($config['ldap_basedn_db'] == TRUE) {
                    ...
                    $row = $res->fetch_assoc();
                    if (count($row) == 0) {
                        echo '<b>ERROR:</b> The user wasn\'t found into SmartHrms\'s database.<br />' . PHP_EOL;
                    } else {
...
?>
            ...
            <ul>
                <li>Whether you are using LDAP or Microsoft Active Directory, the users must be created into SmartHrms (of course, we'll not use the password stored into DB).</li>
...
$ setsebool -P httpd_can_network_connect 1
                ...
                <li>Some LDAP servers require the application server (eg SmartHrms) to be whitelisted.</li>
            </ul>
