...
<html>
    <head>
    <title>SmartHrms Requirements</title>
    ...
    <body>
        <div class="container-fluid">
            ...
            <h1>SmartHrms Requirements</h1>

            <noscript>
                Javascript is disabled. SmartHrms requires Javascript to be enabled.
            </noscript>
            ...
            <table class="table table-bordered table-hover table-condensed">
                <thead>
                  ...
                  <tbody id="tblServer">
                      ...
                      <tr><td><i class="mdi mdi-check"></i>&nbsp;SmartHrms can write into logs folder</td>
                      <?php } else { ?>
                      <tr><td><i class="mdi mdi-alert"></i>&nbsp;SmartHrms can't write into logs folder</td>
                      <?php } ?><td>The folder application/logs/ must be writable.</td></tr>

                      <?php if (is_writable(realpath('local/upload/leaves/'))) {?>
                      <tr><td><i class="mdi mdi-check"></i>&nbsp;SmartHrms can write files</td>
                      <?php } else { ?>
                      <tr><td><i class="mdi mdi-alert"></i>&nbsp;SmartHrms can't write files</td>
