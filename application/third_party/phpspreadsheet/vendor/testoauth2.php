...
<html>
    <head>
        <title>SmartHrms OAuth2 Configuration</title>
...
<ul>
    ...
    <li>In "Authorized JavaScript origins", add the root of your installation (eg "http://demo.SmartHrms.org").</li>
    <li>The field "Authorized redirect URIs" must be blank.</li>
    <li>Don't forget to save and to note Client ID and Client secret.</li>
</ul>

<h3>Setup SmartHrms</h3>

<p>Setup SmartHrms by editing <code>application/config/config.php</code></p>
...
<ul>
    ...
    <li>Set <code>oauth2_client_secret</code> with the value you got from Google developers console.</li>
            ...
            <p>In case your system is not up-to-date, SmartHrms is bundled with a list of trusted certicates into <code>assets/keys/cacert.pem</code>. The absolute path to this file must be known by either:</p>
