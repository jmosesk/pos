...
<html>
    <head>
        <title>SmartHrms Email Configuration</title>
...
if (EMAIL_ADDRESS == '') {
    ...
    if ($configFileExists && $configCIFileExists) {
        ...
        try {
            ...
            $mail->SetFrom($config['from_mail'], "SmartHrms application");
...
$ setsebool -P httpd_can_network_connect 1
                    ...
                    <li>Some SMTP server require the application server sending emails (i.e. SmartHrms) to be whitelisted (on the SMTP server).</li>
